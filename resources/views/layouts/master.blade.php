                ...
                <div class="sidebar-menu mt-4">
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item {{ request()->is('kas-kartar-pemasukan*') ? 'active' : '' }}">
                                    <a href={{ url('kas-kartar-pemasukan') }}>Pemasukan Kas Karang Taruna</a>
                                </li>
                                <li class="submenu-item {{ request()->is('kas-kartar-pengeluaran*') ? 'active' : '' }}">
                                    <a href={{ url('kas-kartar-pengeluaran') }}>Pengeluaran Kas Karang Taruna</a>
                                </li>
                            </ul>
                        </li>
                        {{-- Kas Sosial --}}
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item {{ request()->is('kas-kartar-rekap*') ? 'active' : '' }}">
                                    <a href={{ url('kas-kartar-rekap') }}>Rekap Kas Karang Taruna</a>
                                </li>
