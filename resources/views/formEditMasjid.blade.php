...
<div class="modal fade" id="editKarTar{{$d ->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form action={{url('/dashboard/edit/' . $d ->id)}} method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{$d->kartar}}" id="formGroupExampleInput" placeholder="Nama Masjid" name="masjid">
                      </div>
                      
                      <div class="mb-3">
                        <label for="formGroupExampleInput2" class="form-label">Foto Profile</label>
                            <div class="col-md-8 mb-3">
                                <img src="{{ asset('/storage/kartar/' .$d->image) }}" class="card-img" alt="..." style="height:180px;"/>
                            </div>
